...
import ChoreIntervalFields from '@/components/modules/chore-chart/ChoreIntervalFields';
  ...
  return (
    <>
      ...
      >
        ...
        {frequency === 'interval' && <ChoreIntervalFields form={f} />}
        ...
        {rotation !== 'schedule' && frequency !== 'interval' && (
          <div style={{ marginBottom: 24 }}>
