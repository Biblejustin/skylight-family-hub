...
export interface FullscreenCalendarConfig {
  /** Touch controls for week/month browsing; navigation stays local to the display. */
...
export type ChoreResetFrequency = 'daily' | 'weekly' | 'biweekly' | 'once' | 'interval';
...
export interface ChoreDefinition {
  ...
  intervalDays?: number;            // Positive whole days — required for 'interval'
  anchorDate?: string;              // First occurrence, YYYY-MM-DD — required for 'interval'
...
export interface FullscreenChoreChartConfig {
  /** Choose a household member before showing their tappable chore checklist. */
  personSelection?: boolean;
