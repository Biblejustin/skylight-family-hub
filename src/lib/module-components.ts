...
const builtinComponentEntries = {
  ...
  'fullscreen-calendar': dynamic(() => import('@/components/modules/fullscreen-calendar/InteractiveCalendarModule')),
  ...
  'fullscreen-news': dynamic(() => import('@/components/modules/fullscreen-news/FullscreenNewsModule')),
